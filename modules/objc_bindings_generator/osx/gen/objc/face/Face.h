 ...
 * The Face module
 *
 * Member classes: `FaceRecognizer`, `BIF`, `Facemark`, `FacemarkAAM`, `FacemarkLBF`, `FacemarkTrain`, `BasicFaceRecognizer`, `EigenFaceRecognizer`, `FisherFaceRecognizer`, `LBPHFaceRecognizer`, `FacemarkKazemi`, `MACE`, `PredictCollector`, `StandardCollector`
 *
 */
